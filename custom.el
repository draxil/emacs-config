(custom-set-variables
 ...
 '(godef-command "/home/joe/code/go/bin/godef")
 '(lj-default-server "www.dreamwidth.org")
 '(menu-bar-mode nil)
 '(notmuch-hello-sections
   '(notmuch-hello-insert-header notmuch-hello-insert-saved-searches notmuch-hello-insert-recent-searches notmuch-hello-insert-alltags notmuch-hello-insert-footer))
 ...
 '(safe-local-variable-values
   '((gofmt-args "-local" "github.com/River-Island/svi-services")
     (eval progn)
     (eval setq-local yas-snippet-dirs
	   (append yas-snippet-dirs
		   '("/Users/joe.higton/code/ri/product-injector-api")))
     (gofmt-command . "goimports")
     (eval setq-local
	   (if yas-snippet-dirs yas-snippet-dirs)
	   (append yas-snippet-dirs
		   '("/home/joe/.emacs.d/ri/injector-snippets/")))
     (eval setq-local yas-snippet-dirs
	   (append yas-snippet-dirs
		   '("/home/joe/.emacs.d/ri/injector-snippets/")))
     (rinj-go-mode . t)
     (org-startup-with-inline-images quote t)
...
;;  ;; Your init file should contain only one such instance.
;;  ;; If there is more than one, they won't work right.
;;  '(default ((t (:inherit nil :stipple nil :background "black" :foreground "grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "unknown" :family "Hack"))))
